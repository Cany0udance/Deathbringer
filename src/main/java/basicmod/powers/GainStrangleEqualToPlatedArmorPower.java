...
public class GainStrangleEqualToPlatedArmorPower extends BasePower implements OnMyBlockBrokenPower, CloneablePowerInterface {
    public static final String POWER_ID = makeID("GainStrangleEqualToPlatedArmor");
    private static final AbstractPower.PowerType TYPE = AbstractPower.PowerType.DEBUFF;
    private static final boolean TURN_BASED = false;

    public GainStrangleEqualToPlatedArmorPower(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new GainStrangleEqualToPlatedArmorPower(this.owner, this.amount);
    }
}
