...
public class SeepParticle extends AbstractGameEffect {
    ...
    public SeepParticle(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.color = new Color(0.0F, 1.0F, 0.00F, 0.6F);
        this.duration = 0.7F;
    ...
    private void updateMovement() {
        ...
        if (this.controlPoints.size() > 3) {
            ...
            this.crs.set(this.controlPoints.toArray(new Vector2[0]), false);
