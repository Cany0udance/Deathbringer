...
public class BlackFlowersPetalEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float vX;
    ...
    public BlackFlowersPetalEffect() {
        ...
        this.color = new Color(0.1F, 0.1F, 0.1F, 1.0F);
        this.duration = 4.0F;
    }
    ...
    private void renderImg(SpriteBatch sb, Texture img, boolean flipH, boolean flipV) {
        sb.setBlendFunction(770, 771); // Standard alpha blending
