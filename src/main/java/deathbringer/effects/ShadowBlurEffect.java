...
public class ShadowBlurEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float aV;
    ...
    public ShadowBlurEffect(float x, float y) {
        float randomGrayScale = MathUtils.random(0.0F, 0.2F);  // Shades of dark gray
        this.color = new Color(randomGrayScale, randomGrayScale, randomGrayScale, 1.0F);
