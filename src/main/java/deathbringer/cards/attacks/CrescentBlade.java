...
public class CrescentBlade extends BaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        int totalDamage = this.baseDamage + (deathbringer.Deathbringer.shadowplaysThisCombat * this.magicNumber);
    ...
    public void applyPowers() {
        ...
        this.baseDamage += deathbringer.Deathbringer.shadowplaysThisCombat * this.magicNumber;
        super.applyPowers();
